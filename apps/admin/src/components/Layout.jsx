...
const NAV = [
  ...
  { label: 'Roster',             path: '/admin/roster',            icon: 'calendar_month' },
  { label: 'Field Attendance',   path: '/admin/field-attendance',  icon: 'location_on' },
...
const PAGE_TITLES = {
  ...
  '/admin/field-attendance':   'Field Attendance',
